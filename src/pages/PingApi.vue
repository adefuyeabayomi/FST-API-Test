...
export default defineComponent({
  ...
  methods: {
    ...
    async testEduEnrollment() {
      ...
      try {
        const result = await pingService.eduEnrollment(enrollmentData);
        this.response = JSON.stringify(result, null, 2);
      } catch (error:any) {
        this.response = `Error: ${error.message}`;
      }
          ...
          <div class="row">
            ...
            <div class="border p-2">
              ...
              <div class="border my-2 p-2" id="pingReq01">
                ...
                <p><strong>Description:</strong> Performs a ping request and returns pong.</p>
              ...
              <div class="border my-2 p-2" id="pingReq03">
                ...
                <Button @click="testRequestLogs" buttonVal="Test Request Logs" />
              </div>
              ...
              <div class="border my-2 p-2" id="pingReq05">
                ...
                <Button @click="clearRequestLogs" buttonVal="Clear Request Logs" />
              </div>
              ...
              <div class="border my-2 p-2" id="pingReq07">
                <p><strong>Endpoint: /class-enrollment</strong></p>
                <p><strong>Method:</strong> POST</p>
                <p><strong>Description:</strong> Enrolls a user in a class.</p>
                <p><strong>Request Body Example:</strong></p>
                <pre>{ "course": "Math", "name": "John Doe", "email": "john@example.com", "phoneNumber": "1234567890" }</pre>
                <Button @click="testEduEnrollment" buttonVal="Test Edu Enrollment" />
              </div>
            </div>
          </div>
