      ...
      <div class="col-6 p-2">
        ...
        <div class="border my-2 p-2" id="profileReq01">
          ...
          <div class="loginform border r-1 p-2">
            <p>Input Form</p>
            <Input
              v-model="createProfileData.firstName"
              placeholder="Enter First Name"
            />
            <p></p>
            <Input
              v-model="createProfileData.lastName"
              placeholder="Enter Last Name"
            />
            <p></p>
            <Input
              v-model="createProfileData.gender"
              placeholder="Enter Gender"
            />
            <p></p>
            <p class="text-bold">
              Selected Date: {{ createProfileData.dateOfBirth }}
            </p>
            <DateInput
              v-model="createProfileData.dateOfBirth"
            ...
            <p></p>
            <Input
              v-model="createProfileData.location"
              placeholder="Enter Location"
            />
            <p></p>
            <Input
              v-model="createProfileData.website"
              placeholder="Enter Website"
            />
            <p></p>
            <Input
              v-model="createProfileData.username"
        ...
        <div class="border my-2 p-2" id="profileReq03">
          ...
          <p><strong>Request Body:</strong></p>
          <pre>
{ "name": "John Doe Updated", "email": "john.doe.updated@example.com" }</pre
          >
          <p><strong>Responses:</strong></p>
          <ul>
          ...
          <div class="loginform border r-1 p-2">
            <p>Update Form</p>
            <Input
              v-model="updateProfileData.firstName"
              placeholder="Enter First Name"
            />
            <p></p>
            <Input
              v-model="updateProfileData.lastName"
              placeholder="Enter Last Name"
            />
            <p></p>
            <Input
              v-model="updateProfileData.gender"
              placeholder="Enter Gender"
            />
            <p></p>
            <p class="text-bold">
              Selected Date: {{ updateProfileData.dateOfBirth }}
            </p>
            <DateInput
              v-model="updateProfileData.dateOfBirth"
              placeholder="Enter Date of Birth"
            />
            <p></p>
            ...
            <p></p>
            <Input
              v-model="updateProfileData.location"
              placeholder="Enter Location"
            />
            <p></p>
            <Input
              v-model="updateProfileData.website"
              placeholder="Enter Website"
            />
            <p></p>
            <Input
        ...
        <div class="border my-2 p-2" id="profileReq04">
          ...
          <Button
            @click="testUploadProfileImage"
            buttonVal="Test Upload Image"
          />
        </div>
        ...
        <div class="border my-2 p-2" id="profileReq06">
          ...
          <p><strong>Method:</strong> GET</p>
          <p>
            <strong>Description:</strong> Search profiles based on query
            parameters
          </p>
          ...
          <Button
            @click="testSearchProfiles"
            buttonVal="Test Search Profiles"
          />
        </div>
        ...
        <div class="border my-2 p-2" id="profileReq07">
          ...
          <p><strong>Method:</strong> GET</p>
          <p>
            <strong>Description:</strong> Get a list of profiles with pagination
          </p>
